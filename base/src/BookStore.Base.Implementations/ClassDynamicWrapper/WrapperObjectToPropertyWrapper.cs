...
public class WrapperObjectToPropertyWrapper : IWrapperObjectToPropertyWrapper
{
    private readonly ModuleBuilder _dynamicModuleBuilder;

    public WrapperObjectToPropertyWrapper()
    {
        var wrappersDynamicAssembly = new AssemblyName(
            $"WrappersDynamicAssembly_{Guid.NewGuid()}");
        ...
        _dynamicModuleBuilder = dynamicAssemblyBuilder
            .DefineDynamicModule(wrappersDynamicAssembly.Name!);
    }

    public object Wrap<TToWrap>(TToWrap objectToPropertyWrapper) where TToWrap : class
    {
        var dynamicTypeBuilder = _dynamicModuleBuilder.DefineType(
