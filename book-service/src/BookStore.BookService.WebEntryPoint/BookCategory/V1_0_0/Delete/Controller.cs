...
namespace BookStore.BookService.WebEntryPoint.BookCategory.V1_0_0.Delete;
...
public class Controller : BookStoreControllerBase
{
    ...
    {
        var targetResource = _bookCategoryResource.Delete(bookCategory =>
            bookCategory.CategoryId = bookCategory.CategoryId);
